...
export const welcomePrintingJobTextList = [
    PJ("text", {text: "Hello stranger!"}),
    PJ("text", {text: "Welcome... Welcome..."}),
    ...
    PJ("text", {text: "if you wish to know more about me, my life or my cat..."}),
    PJ("text", {text: "or my social insurance number"}),
    PJ("text", {text: "please type /help"}),
    PJ("line", {height: 2}),
